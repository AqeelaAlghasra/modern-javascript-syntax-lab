...
const userProfile= { [propertyName]:'Aqeela'}
...
function nounAdjective(noun='cat', adjective='orange') {
...
const theme = 'light' || savedUserTheme;

console.log(`theme is equal to ${theme}`)
